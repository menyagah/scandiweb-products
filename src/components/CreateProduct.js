          ...
          <tbody>
            <tr>
              ...
              <td>
                <input
                  type="text"
                  className={errors["sku"] ? "invalid" : null}
                  name="sku"
                  id="sku"
            ...
            <tr>
              ...
              <td>
                <input
                  type="number"
                  className={errors["price"] ? "invalid" : null}
                  name="price"
                  onChange={handleChange}
                />
                {errors["price"] ? (
